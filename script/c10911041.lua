...
function s.drfilter(c)
	return c:IsSummonType(SUMMON_TYPE_FUSION) and c:IsLevel(4) and not c:IsCode(id)
end
...
function s.spfilter(c, e, tp)
	return c:IsLevel(4) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) and not c:IsCode(id)
		and c:IsFaceupEx()
end
