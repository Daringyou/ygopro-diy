...
function s.filter(c,tp)
	return (c:IsLocation(LOCATION_MZONE) or c:IsHasEffect(EFFECT_EXTRA_FUSION_MATERIAL,tp)) and c:IsCanBeFusionMaterial() and c:IsAbleToGrave() and (c:IsFaceup() or c:IsPublic())
end
